...
const CarouselWrapper = ({
  ...
  }, slideButton && /*#__PURE__*/React.createElement("button", {
    onMouseOver: () => setHoverBool(true),
    onMouseOut: () => setHoverBool(false),
    onClick: () => updateStyle(index, decrement),
    className: `carousel-indicator indicator-left`
  }, /*#__PURE__*/React.createElement("img", {
    src: angleLeft,
    alt: "arrow_left"
  })), Children.map(children, child => {
    return /*#__PURE__*/cloneElement(child, {
      className: `${itemName} carousel-item`
    });
  }), slideButton && /*#__PURE__*/React.createElement("button", {
    onMouseOver: () => setHoverBool(true),
    onMouseOut: () => setHoverBool(false),
    onClick: () => updateStyle(index, increment),
    className: `carousel-indicator indicator-right`
  }, /*#__PURE__*/React.createElement("img", {
    src: angleRight,
    alt: "arrow_right"
  }))));
